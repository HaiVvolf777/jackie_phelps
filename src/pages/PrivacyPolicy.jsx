  ...
  return (
    <div className="bg-[#7C98B1] text-gray-800 py-[100px] px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <p className="mb-4">
          We recognize that you may be concerned about our use and disclosure of your personal information. Your privacy is very important to us, and the following will inform you of the information that we, Jacki Phelps Law, may collect from you, and how it is used. By using our website, www.jackiphelps.com, you are accepting the practices described in this policy.
        </p>
        ...
        <p className="mb-4">
          We use the collected information solely for our own internal purposes, such as providing, maintaining, evaluating, and improving our services and website, fulfilling requests for information, and providing customer support.
        </p>
