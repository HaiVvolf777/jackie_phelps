...
const Schedule = () => {
    return (
        <>
            <div className="container mx-auto text-black py-[200px] px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 items-center">
                    <div>
                        <h1 className="text-[#39648C] text-5xl font-bold mb-8">
                        ...
                        <h1 className="text-[#39648C] text-4xl font-bold mb-8">
                            How It Works
                        </h1>
