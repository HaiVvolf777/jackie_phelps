        ...
        <nav className={`pt-[0.5vw] fixed top-0 z-50 w-full ${isScrolled ? 'bg-[#7C98B1]' : 'bg-transparent'}`}>
            <div className="container mx-auto px-[30px] flex justify-between items-center h-20 w-full">
                ...
                <div className="hidden lg:flex items-center space-x-4">
                    ...
                    <Link to="/appointment" className="w-full text-center bg-[#39648C] text-white px-4 py-2 rounded-md hover:scale-105 transition-all duration-500">
                        Book an Appointment
                    </Link>
                </div>
                ...
                <div className="-mr-2 flex items-center lg:hidden">
                    ...
                    >
                        {isOpenMenu ? <FaTimes className="h-6 w-6" /> : <FaBars className="h-6 w-6" />}
                    </button>
                </div>
            </div>
